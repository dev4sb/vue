...
const i18nCookiesPlugin = ({ $cookies, i18n, app, redirect }) => {
  const i18nOptions = {"currency":"USD","country":"US","countries":[{"name":"US","label":"United States"},{"name":"DE","label":"Germany"}],"currencies":[{"name":"EUR","label":"Euro"},{"name":"USD","label":"Dollar"}],"locales":[{"code":"en","alias":"us","label":"English","file":"en.js","iso":"en"},{"code":"de","alias":"de","label":"German","file":"de.js","iso":"de"}],"defaultLocale":"en","lazy":true,"seo":true,"langDir":"lang\u002F","vueI18n":{"fallbackLocale":"en","numberFormats":{"en":{"currency":{"style":"currency","currency":"USD","currencyDisplay":"symbol"}},"de":{"currency":{"style":"currency","currency":"GBP","currencyDisplay":"symbol"}}}},"detectBrowserLanguage":{"cookieKey":"vsf-locale"}};
